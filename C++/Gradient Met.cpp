...
// Gradient Method with Step Fractionation
int Gmet(double &x,double &y,double eps,int &nEvF,int &nEvG) {
...
cout<<"\n    ***   Gradiet method with step fractionation ***\n";
 k=Gmet(x,y,0.00001,nEvF,nEvG);
  cout<<"min f(x,y) = f("<<x<<","<<y<<") = "<<f(x,y)<<endl
      <<"The number of iterations: "<<k<<endl
